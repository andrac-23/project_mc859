...
def parse_arguments():
    ...
    ap.add_argument(
        ...
        default=None,
        help='sorting order for reviews',
    )
    ap.add_argument(
        '--stop-on-match',
        action='store_true',
    ...
    ap.add_argument(
        '--url', type=str, default=None, help='custom Google Maps URL to scrape'
    )
    ap.add_argument(
        '--overwrite',
        action='store_true',
    ...
    ap.add_argument(
        '--custom-url-base', type=str, default=None, help='base URL for replacement'
    )
    ap.add_argument(
        '--custom-url-profiles', type=str, default=None, help='path for profile images'
    )
    ap.add_argument(
        '--custom-url-reviews', type=str, default=None, help='path for review images'
    )
    ap.add_argument(
